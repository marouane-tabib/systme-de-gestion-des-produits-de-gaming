<div class="side-bar-box col-md-2 col-2 bg-light shadow shadow-sm <?php if (!isset($_SESSION['user'])) { echo 'd-none';} ?>">
  <div class="row bg-white py-3 px-2 my-2 shadow shadow-sm">
    <a href="index.php">
